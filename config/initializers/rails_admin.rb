# RailsAdmin config file. Generated on October 09, 2012 10:38
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Yaes', 'Admin']
  ...
  # config.excluded_models = ['AdminUser', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['AdminUser', 'User']
  ...
  #     configure :id, :integer 
  #     configure :container_user_id, :string 
